...
class Datasets():
    ...
    def calc_mean_and_std(self):
        ...
        # Axis is a tuple so that a mean is performed over multiple axes, 
    ...
    def standardize(self, img):
        ...
        #print(img)
        #print('successfully standardized image')
    ...
    def get_data(self, path, is_vgg, shuffle, augment):
        ...
        if augment:
            ...
            # modified versions of images in the dataset. Training deep 
            # learning neural network models on more data can result in more 
            # skillful models, and the augmentation techniques can create 
            # variations of the images that can improve the ability of the 
            # fit models to generalize what they have learned to new images.
            # https://machinelearningmastery.com/how-to-configure-image-data-augmentation-when-training-deep-learning-neural-networks/
            data_gen = tf.keras.preprocessing.image.ImageDataGenerator(
                #rescale=1./255, ### this was added 
                width_shift_range=0.25, # shift the images left and right by half their width
                height_shift_range=0.25, # shift the image ups and down by half their height
                rotation_range=25, # rotations to the image between 0 and 90 degrees
                #rescale = 1/255,
                horizontal_flip=True, # flip the images horizontally 
                brightness_range=[0.6,1.1], # randomly darken the image between 1.0 (no change) and 0.2 or 20%
                zoom_range=[0.6,1.4], # changing the zoom/scale of the images
